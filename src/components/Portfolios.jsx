            ...
            <section className="flex w-full min-h-screen px-5 md:px-20 pt-20 md:pt-32">
                <div className="flex flex-col w-full">
                    <article className="md:flex md:items-center mb-5 md:mb-10 w-full pb-5 md:pb-10 border-b gap-4">
                        ...
                        <p className="md:w-1/2 text-sm lg:text-lg text-right">Liste des profils acceptés. Il est possible de tomber sur des profils francophones hors France. Ses profils ont été accepté dans le cadre où les personnes concernées s'investissent dans la communauté francophone où recherche un emploi en France.</p>
                    </article>
