            ...
            {randomIndex !== null && members.length > 0 && (
                <article className="lg:flex gap-4 w-full">
                    <aside className="lg:w-1/2 h-content">
                        ...
                        <a href={members[randomIndex].url_portfolio} className="block lg:hidden transition delay-75 h-56 mr-0 ml-auto hover:scale-105 mb-5"><img src={"http://127.0.0.1:8000/members/image_portfolio_by_id?id_member=" + members[randomIndex].id_member} alt="Profile Image" className="object-cover hover:contrast-125 h-56 duration-200 border border-black w-full"/></a>
                        <p className="text-base md:text-lg lg:text-2xl md:mb-5 text-justify md:border-b pb-5">Voici un profil que nous souhaitons mettre en avant.</p>
                    ...
                    <a href={members[randomIndex].url_portfolio} className="hidden lg:block transition delay-75 h-56 mr-0 ml-auto w-1/2 hover:scale-105"><img src={"http://127.0.0.1:8000/members/image_portfolio_by_id?id_member=" + members[randomIndex].id_member} alt="Profile Image" className="object-cover hover:contrast-125 h-56 duration-200 border border-black w-full"/></a>
                </article>
            )}
        </>
    );
