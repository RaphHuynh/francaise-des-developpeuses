        ...
        <>
            {randomIndex !== null && members.length > 0 && (
                <article className="lg:flex gap-4 w-full">
                    ...
                    <a href={members[randomIndex].url_portfolio} className="hidden lg:block transition delay-75 h-56 mr-0 ml-auto w-1/2 hover:scale-105"><img src={`${baseUrl}/member/image_portfolio_by_id?id_member=` + members[randomIndex].id_member} alt="Profile Image" className="object-cover hover:contrast-125 h-56 duration-200 border border-black w-full"/></a>
                </article>
            )}
        </>
    );
