  ...
  return (
    <>
      <article className="lg:grid lg:grid-cols-3 md:gap-8">
        ...
        <aside className="col-span-2 mt-5">
          ...
          <p className="md:text-lg lg:text-xl text-justify">
            J&apos;ai réalisé ce site afin de mettre en valeur les femmes dans
            le monde de la tech qui reste majoritairement masculin.
          </p>
        </aside>
      </article>
      <hr className="mt-5" />
      <article className="flex flex-row gap-8">
        ...
        <aside className="hidden lg:col-span-2 lg:mt-5 lg:flex lg:justify-center lg:items-center">
          <Image
            src="/assets/thibault.jpeg"
            alt="test"
            width={1000}
            height={1000}
            className="w-full h-auto"
